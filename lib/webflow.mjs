...
export function buildFieldData(frontmatter, htmlBody, thumbnailUrl = null, { excludeSlug = false } = {}) {
  ...
  // Add thumbnail if provided (field name is 'feature-image' in Webflow)
  if (thumbnailUrl) {
    fieldData['feature-image'] = thumbnailUrl;
  }
