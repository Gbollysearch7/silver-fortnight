...
3. **External authority links (REQUIRED — include at least 2):**
   - Investopedia (definitions, educational)
   - TradingView (charts, market data)
   - CFTC/SEC/FINRA (regulations)
   - BabyPips, DailyFX, MyFXBook (trading education)
   - Forbes, Bloomberg, WSJ, Reuters (market news)
   - Use descriptive anchor text, link naturally in context
4. **Internal linking:** Include 3+ links to TradersYard pages:
   ...
   - Reference related blog topics naturally
