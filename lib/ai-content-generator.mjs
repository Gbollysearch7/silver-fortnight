...
Weave these links into relevant paragraphs using descriptive anchor text. Do NOT list them — embed them in sentences where they add value.`;
  ...
  if (tier <= 10) {
    let prompt = `Write a concise, helpful blog post for TradersYard (a prop trading firm offering funded accounts up to $200K, 80% profit split, 1-Step and 2-Step challenges).
